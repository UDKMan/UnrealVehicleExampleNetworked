...
protected:
	...
	TWeakObjectPtr<class AVehicleTrackPoint> LastTrackPoint;

	/** game menu container widget - used for removing */
	TSharedPtr<class SWeakWidget> GameMenuContainer;

	/** HUD menu widget */
	TSharedPtr<class SVehicleMenuWidget> MyHUDMenuWidget;

	/** HUD widget */
	TSharedPtr<class SVehicleHUDWidget> VehicleHUDWidget;
