...
void SVehicleControlsSetup::RemapKey(TSharedPtr<FActionBinding> Binding, const FKey Key, bool bForcedAxis, bool bForcedAction)
{
	if (GEngine)
	{
		...
		else if (Binding->AxisMapping != NULL)
		{
			Binding->BindConfig->Key = Key;
	...
	return
		...
		[
			...
			[
				...
				[
					SNew(STextBlock)
					.Text( Item->BindConfig->DisplayName.ToString() )
...
void SVehicleControlsSetup::PopulateFriendlyKeyNameMap()
{
	...
	// Analog sticks
	Remap = AddFriendlyKeyNameRemap(EKeys::Gamepad_LeftStick_Up, LOCTEXT("Gamepad_Left_Stick", "Left Stick").ToString(), EConsoleForGamepadLabels::PS4);
	...
	Remap->AddUnique(EKeys::Gamepad_LeftX);
	Remap->AddUnique(EKeys::Gamepad_LeftY);

	Remap = AddFriendlyKeyNameRemap(EKeys::Gamepad_RightX, LOCTEXT("Gamepad_Right_Stick", "Right Stick").ToString(), EConsoleForGamepadLabels::PS4);
	...
	Remap->AddUnique(EKeys::Gamepad_RightX); 
	Remap->AddUnique(EKeys::Gamepad_RightY);
	...
	// Buttons
	AddFriendlyKeyNameRemap(EKeys::Gamepad_FaceButton_Top, LOCTEXT("Gamepad_FaceButton_Top", "Y").ToString(), EConsoleForGamepadLabels::XBoxOne);
	AddFriendlyKeyNameRemap(EKeys::Gamepad_FaceButton_Bottom, LOCTEXT("Gamepad_FaceButton_Bottom", "A").ToString(), EConsoleForGamepadLabels::XBoxOne);
	AddFriendlyKeyNameRemap(EKeys::Gamepad_FaceButton_Left, LOCTEXT("Gamepad_FaceButton_Left", "X").ToString(), EConsoleForGamepadLabels::XBoxOne);
	AddFriendlyKeyNameRemap(EKeys::Gamepad_FaceButton_Right, LOCTEXT("Gamepad_FaceButton_Right", "B").ToString(), EConsoleForGamepadLabels::XBoxOne);
	...
	Remap = AddFriendlyKeyNameRemap(EKeys::Gamepad_LeftStick_Up, LOCTEXT("XBoxOne_Left_Stick", "Left Stick").ToString(), EConsoleForGamepadLabels::XBoxOne);
	Remap->AddUnique(EKeys::Gamepad_LeftStick_Down);
	Remap->AddUnique(EKeys::Gamepad_LeftStick_Left);
	Remap->AddUnique(EKeys::Gamepad_LeftStick_Right);
	Remap->AddUnique(EKeys::Gamepad_LeftX);
	...
	Remap = AddFriendlyKeyNameRemap(EKeys::Gamepad_RightX, LOCTEXT("XBoxOne_Right_Stick", "Right Stick").ToString(), EConsoleForGamepadLabels::XBoxOne);
	Remap->AddUnique(EKeys::Gamepad_RightStick_Up);
	Remap->AddUnique(EKeys::Gamepad_RightStick_Down);
	Remap->AddUnique(EKeys::Gamepad_RightStick_Left);
	Remap->AddUnique(EKeys::Gamepad_RightStick_Right);
	...
	// Buttons
	AddFriendlyKeyNameRemap(EKeys::Gamepad_FaceButton_Top, LOCTEXT("Gamepad_FaceButton_Top", "Y").ToString(), EConsoleForGamepadLabels::None);
	AddFriendlyKeyNameRemap(EKeys::Gamepad_FaceButton_Bottom, LOCTEXT("Gamepad_FaceButton_Bottom", "A").ToString(), EConsoleForGamepadLabels::None);
	AddFriendlyKeyNameRemap(EKeys::Gamepad_FaceButton_Left, LOCTEXT("Gamepad_FaceButton_Left", "X").ToString(), EConsoleForGamepadLabels::None);
	AddFriendlyKeyNameRemap(EKeys::Gamepad_FaceButton_Right, LOCTEXT("Gamepad_FaceButton_Right", "B").ToString(), EConsoleForGamepadLabels::None);
	
	// Specials
	AddFriendlyKeyNameRemap(EKeys::Gamepad_Special_Left, LOCTEXT("Gamepad_SpecialLeft", "Back").ToString(), EConsoleForGamepadLabels::None);
	AddFriendlyKeyNameRemap(EKeys::Gamepad_Special_Right, LOCTEXT("Gamepad_SpecialRight", "Start").ToString(), EConsoleForGamepadLabels::None);
	...
	AddFriendlyKeyNameRemap(EKeys::Gamepad_RightThumbstick, LOCTEXT("Gamepad_RightThumbstick", "R Stick Click").ToString(), EConsoleForGamepadLabels::None);
 	...
 	Remap = AddFriendlyKeyNameRemap(EKeys::Gamepad_LeftStick_Up, LOCTEXT("Gamepad_Left_Stick", "Left Stick").ToString(), EConsoleForGamepadLabels::None);
  	Remap->AddUnique(EKeys::Gamepad_LeftStick_Down);
	Remap->AddUnique(EKeys::Gamepad_LeftStick_Left);
	Remap->AddUnique(EKeys::Gamepad_LeftStick_Right);
	Remap->AddUnique(EKeys::Gamepad_LeftX); 
	...
	Remap = AddFriendlyKeyNameRemap(EKeys::Gamepad_RightX, LOCTEXT("Gamepad_Right_Stick", "Right Stick").ToString(), EConsoleForGamepadLabels::None);	
	Remap->AddUnique(EKeys::Gamepad_RightStick_Up);
	Remap->AddUnique(EKeys::Gamepad_RightStick_Down);
	Remap->AddUnique(EKeys::Gamepad_RightStick_Left);
	Remap->AddUnique(EKeys::Gamepad_RightStick_Right);
...
FText SVehicleControlsSetup::GetItemKeyBinding(TSharedPtr<FActionBinding> Item) const
{
	...
	else if (Item->InputMapping != NULL)
	{
		ResultText = GetKeyText(Item->InputMapping->Key);
	} 
	else if (Item->AxisMapping != NULL)
	{
...
bool SVehicleControlsSetup::IsBindingAllowed(TSharedPtr<FActionBinding> Binding, const FKey Key, bool bForcedAxis, bool bForcedAction)
{
	for (int32 Bind = 0; Bind < BindingRestrictions.Num(); Bind++)
	{
		...
		{			
			...
			const FString AxisName = Binding.Get()->AxisMapping != NULL ? Binding.Get()->AxisMapping->AxisName.ToString() : FString();
			const FString InputName = Binding.Get()->InputMapping != NULL ? Binding.Get()->InputMapping->ActionName.ToString() : FString();
